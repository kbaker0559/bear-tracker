...
export const initialPlayers: Player[] = names.map(([name, handicap, quota], i) => ({ id: `p${i+1}`, name, handicap, quota, active: true, pin: String(1000+i), isAdmin: name === 'Kevin Baker' }));
